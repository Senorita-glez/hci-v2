...
export default Store = () => {
  ...
  addProductToCart = () => {
    Alert.alert('Edit', 'Lets edit the procut')
  }
                ...
                <View style={styles.socialBarContainer}>
                  <View style={styles.socialBarSection}>
                    <TouchableOpacity
                      ...
                      <Image
                        style={styles.icon}
                        source={{
                          uri: 'https://img.icons8.com/?size=100&id=78757&format=png&color=000000',
                        }}
                      />
                    </TouchableOpacity>
                  </View>
                  <View style={styles.socialBarSection}>
                    <TouchableOpacity style={styles.socialBarButton}>
                      <Image
                        style={styles.icon}
                        source={{ uri: 'https://img.icons8.com/color/50/000000/hearts.png' }}
                      />
